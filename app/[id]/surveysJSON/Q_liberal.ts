export const Q_liberal = {
  "locale": "fr",
  "title": {
    "default": "Questionnaire MOTS",
    "fr": "Questionnaire en pratique libérale"
  },
  "logoPosition": "right",
  "pages": [
    {
      ...
      "elements": [
        ...
        },
        {
          ...
          "name": "D1_3",
          "title": {
            "default": "Je pratique l’autodiagnostic et / ou l’automédication",
        ...
        },
        {
          ...
          "choices": [
            ...
            },
            {
              ...
              "text": {
                "default": "Non",
                "fr": "Non je dépasse régulièrement les recos d'usage et/ou j'ai le sentiment de consommer trop régulièrement de l'alcool"
              }
            },
            {
              "value": "5",
    ...
    },
    {
      ...
      "elements": [
        ...
        },
        {
          ...
          "title": {
            "default": "Je suis porteur d’une pathologie chronique qui nécessite un suivi par un médecin spécialiste",
            "fr": "J’ai des centres d’intérêts en dehors de mon activité professionnelle"
          },
          "isRequired": true,
          "choices": [
            {
    ...
    },
    {
      ...
      "elements": [
        ...
        },
        {
          ...
          "title": {
            "default": "Je suis porteur d’une pathologie chronique qui nécessite un suivi par un médecin spécialiste",
            "fr": " Je peux déprogrammer des consultations si besoin "
          },
          "isRequired": true,
          "choices": [
            {
        ...
        },
        {
          ...
          "title": {
            "default": "J'estime que ma condition physique est adaptée à mon exercice professionnel ",
            "fr": " Je suis interrompu durant les consultations (téléphone, patient, confrère…) "
          },
          "isRequired": true,
          "choices": [
            {
        ...
        },
        {
          ...
          "title": {
            "default": "J'estime que ma condition physique est adaptée à mon exercice professionnel ",
            "fr": "Je suis  en retard par rapport aux horaires de RDV de mon planning et cela m'est une cause de tension psychique"
          },
          "isRequired": true,
          "choices": [
            {
        ...
        },
        {
          ...
          "title": {
            "default": "J'estime que ma condition physique est adaptée à mon exercice professionnel ",
            "fr": "J'ai du mal à donner des RDV à de nouveaux patients qui me sont personnellement adressés, ou des patients de mon cabinet qui veulent me voir plus rapidement et cela m'est une cause de tension psychique"
          },
          "isRequired": true,
          "choices": [
            {
            ...
            },
            {
              ...
              "text": {
                "default": "Plutôt non",
                "fr": "Non jamais ou quasiment jamais"
              }
            }
          ]
        },
        {
          ...
          "title": {
            "default": "J'estime que ma condition physique est adaptée à mon exercice professionnel ",
            "fr": "Je me sens envahi par les demandes administratives des patients (arrêts-maladie non justifiés, renouvellement d'ordonnances, rédaction de certificats….)"
          },
          "isRequired": true,
          "choices": [
            {
    ...
    },
    {
      ...
      "elements": [
        ...
        },
        {
          ...
          "title": {
            "default": "Je suis porteur d’une pathologie chronique qui nécessite un suivi par un médecin spécialiste",
            "fr": "Je peux réaliser un débriefing émotionnel avec un.e psychologue lors de choc émotionnel professionnel qui le justifie"
          },
          "isRequired": true,
          "choices": [
            {
      ...
      "elements": [
        {
          ...
          "title": {
            "default": "Je suis porteur d’une pathologie chronique qui nécessite un suivi par un médecin spécialiste",
            "fr": " A mon cabinet, je réponds moi-même directement au téléphone"
          },
          "isRequired": true,
          "choices": [
            {
            ...
            },
            {
              ...
              "text": {
                "default": "Oui et mon équilibre médico-professionnel est impacté",
                "fr": "Oui et ça me pose problème"
              }
            },
            {
              "value": "0",
              "text": {
                "fr": "Non jamais ou c'est très rare"
              }
            }
          ]
        },
        ...
        },
        {
          ...
          "title": {
            "default": "Je suis porteur d’une pathologie chronique qui nécessite un suivi par un médecin spécialiste",
            "fr": " Je dispose pour mon cabinet d’un.e assistant.e interne ou externe qui m'aide dans mon activité "
          },
          "isRequired": true,
          "choices": [
            {
    ...
    },
    {
      ...
      "elements": [
        ...
        },
        {
          ...
          "title": {
            "default": "Je suis porteur d’une pathologie chronique qui nécessite un suivi par un médecin spécialiste",
            "fr": "Concernant mon mode de fonctionnement (RDV, visites à domicile, accès sans RDV…) …."
          },
          "isRequired": true,
          "choices": [
            {
            ...
            },
            {
              ...
              "text": {
                "default": "Oui et mon équilibre médico-professionnel est impacté",
                "fr": "J'en suis insatisfait"
              }
            },
            {
              "value": "3",
              "text": {
                "fr": "Me convenait mais commence à devenir pesant pour moi"
              }
            }
          ]
        },
        {
          ...
          "title": {
            "default": "Je suis porteur d’une pathologie chronique qui nécessite un suivi par un médecin spécialiste",
            "fr": "La durée des consultations que je pratique selon les cas, me satisfait"
          },
          "isRequired": true,
          "choices": [
            {
            ...
            },
            {
              "value": "3",
              "text": {
                "fr": "Pas autant que je le voudrais"
              }
            }
          ]
        }
    ...
    },
    {
      ...
      "elements": [
        ...
        },
        {
          ...
          "title": {
            "default": "Je suis porteur d’une pathologie chronique qui nécessite un suivi par un médecin spécialiste",
            "fr": " Je délègue les tâches administratives (sociales, gestion compta…) à un prestataire externe"
          },
          "isRequired": true,
          "choices": [
            {
            ...
            },
            {
              ...
              "text": {
                "default": "Oui et mon équilibre médico-professionnel est impacté",
                "fr": "Non et cela me pose problème"
              }
            },
            {
              "value": "2",
              "text": {
                "fr": "Non et ce n'est pas un problème pour moi"
              }
            }
          ]
        },
        ...
        },
        {
          ...
          "title": {
            "default": "Je suis porteur d’une pathologie chronique qui nécessite un suivi par un médecin spécialiste",
            "fr": "Dans mon exercice libéral, le suivi et le traitement des factures / paiement de mes cotisations professionnelles (Urssaf, carmf, ordre...) est un sujet d'angoisse ou d'inquiétude"
          },
          "isRequired": true,
          "choices": [
            {
    ...
    },
    {
      ...
      "elements": [
        ...
        },
        {
          ...
          "title": {
            "default": "Je suis porteur d’une pathologie chronique qui nécessite un suivi par un médecin spécialiste",
            "fr": "J’ai déjà déclaré une agression verbale ou physique auprès du CDOM et / ou déposé une plainte pour une agression dans le cadre de mon activité professionnelle"
          },
          "isRequired": true,
          "choices": [
            {
    ...
    },
    {
      ...
      "elements": [
        ...
        },
        {
          ...
          "title": {
            "default": "Je suis porteur d’une pathologie chronique qui nécessite un suivi par un médecin spécialiste",
            "fr": "J'ai des relations peu soutenantes voire conflictuelles avec l'administration (CPAM, ARS, URSSAF…). Êtes-vous d'accord avec cette affirmation..."
          },
          "isRequired": true,
          "choices": [
            {
      ...
      "elements": [
        {
          ...
          "title": {
            "default": "Je suis porteur d’une pathologie chronique qui nécessite un suivi par un médecin spécialiste",
            "fr": "Je travaille dans un contexte de proximité avec d'autres soignants (association, CPTS, MSP...)"
          },
          "isRequired": true,
          "choices": [
            {
            ...
            },
            {
              "value": "2",
              "text": {
                "fr": "Non et  je le regrette"
              }
            },
            {
              "value": "-1",
              "text": {
                "fr": "Non et je ne le souhaite pas"
              }
            }
          ]
        },
        {
          ...
          "title": {
            "default": "Je suis porteur d’une pathologie chronique qui nécessite un suivi par un médecin spécialiste",
            "fr": "J’ai des temps d’échanges réguliers et de convivialité dans la journée / dans la semaine avec mes associés ou mon entourage professionnel proche et je trouve cela agréable"
          },
          "isRequired": true,
          "choices": [
            {
        ...
        },
        {
          ...
          "title": {
            "default": "Je suis porteur d’une pathologie chronique qui nécessite un suivi par un médecin spécialiste",
            "fr": "Je me suis constitué un réseau de confrères vers lesquels je peux orienter facilement et rapidement mes patients pour avis et prise en charge complémentaire"
          },
          "isRequired": true,
          "choices": [
            {
        ...
        },
        {
          ...
          "title": {
            "default": "Je suis porteur d’une pathologie chronique qui nécessite un suivi par un médecin spécialiste",
            "fr": "Je participe ou j’organise des rencontres interprofessionnelles pour planifier le suivi ou la prise en charge de certains patients : rencontre ville / hôpital, réunion au lit du patient, de service, de concertation pluridisciplinaire, …"
          },
          "isRequired": true,
          "choices": [
            {
    ...
    },
    {
      ...
      "elements": [
        ...
        },
        {
          ...
          "title": {
            "default": "Je suis porteur d’une pathologie chronique qui nécessite un suivi par un médecin spécialiste",
            "fr": "Je peux orienter facilement les patients qui heurtent ma conscience professionnelle ou avec lesquels je me sens en difficulté  vers un autre confrère"
          },
          "isRequired": true,
          "choices": [
            {
